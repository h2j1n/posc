...
<meta charset="utf-8">
    ...
    <!-- Template Stylesheet -->
    <link href="/css/style.css?ver1.3" rel="stylesheet">
   ...
   <% } %>
    ...
    <!-- 공지사항, 댓글 관련 css -->
    <link href="/css/board.css?ver1.3" rel="stylesheet">
    <link href="/css/detailboard.css" rel="stylesheet">
    <link href="/css/board_form.css?ver1.3" rel="stylesheet">
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                    ...
                    <div class="dropdown">
                     ...
                     <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="/adminManageUser.do">회원관리</a></li>
<!--                         <li><a class="dropdown-item" href="/adminManageLounge.do">게시물 관리</a></li> -->
                        <li><a class="dropdown-item" href="/AdList.do" >광고승인</a></li>
                        <li><a class="dropdown-item" href="/adminManageIT.do" >IT홍보 승인</a></li>
